...
public class FlashlightController {
    ...
    private final ArrayList<WeakReference<FlashlightListener>> mListeners = new ArrayList<WeakReference<FlashlightListener>>(1);
...
//        }
    ...
    public void addListener(FlashlightListener l) {
        synchronized (mListeners) {
            ...
            mListeners.add(new WeakReference<FlashlightListener>(l));
        }
    }
